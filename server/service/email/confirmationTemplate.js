...
<head>
  ...
  <title>Share N Care Depot</title>
    ...
    <tr>
      <td align="center" bgcolor="#e9ecef">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff"
              style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;  border-radius: 10px 10px 0px 0px;">
              <p style="margin: 0;">
                Your reservation is confirmed. Please note reservation details below:
              </p>
            </td>
          </tr>
          <!-- end copy -->
                      ...
                      <tr>
                        <td align="center" bgcolor="#1a82e2" style="border-radius: 30px;
                          ...
                          <ul style="list-style-type: none; padding-left: 0; margin-bottom: 16px;">
                            <li style="margin-bottom:6px; color: violet;">Pick Up Date: ${new Date(start_date).toDateString()}</li>
                            <li style="margin-bottom:6px; color: violet;">Due Back: ${new Date(end_date).toDateString()}</li>
                          </ul>
                          <h2 style="color: black; margin-bottom: 10px;">LOCATION</h2>
                          <p style="color: black; font-size: 16px; line-height: 2.5;">
                          ...
                          <ul style="list-style-type: none; padding-left: 0; margin-bottom: 16px;">
                            <li style="margin-bottom:6px;">Monday to Friday: 5:00 PM–7:00 PM</li>
                            <li style="margin-bottom:6px;">Saturday & Sunday: 2:00 PM–4:00 PM</li>
                          </ul>
                        </td>
                      </tr>
                    </table>
          ...
          <tr>
            <td align="left" bgcolor="#ffffff"
              style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-radius: 0px 0px 10px 10px;">
              <p style="margin: 0;">
                Cheers,<br />
                Thank you
              </p>
